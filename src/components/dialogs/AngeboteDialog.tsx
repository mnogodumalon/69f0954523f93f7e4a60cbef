...
export function AngeboteDialog({ open, onClose, onSubmit, defaultValues, stammdatenList, enablePhotoScan = true, enablePhotoLocation = true }: AngeboteDialogProps) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        if (stammdaten_refName) {
          const stammdaten_refMatch = stammdatenList.find(r => matchName(stammdaten_refName!, [String(r.fields.kunden_csv ?? '')]));
  ...
  const DIALOG_INTENT = defaultValues ? 'Edit Angebote' : 'New Angebote';
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="stammdaten_ref"><SelectValue placeholder="Select..." /></SelectTrigger>
              <SelectContent>
                <SelectItem value="none">—</SelectItem>
                {stammdatenList.map(r => (
                  <SelectItem key={r.record_id} value={r.record_id}>
                    {r.fields.kunden_csv ?? r.record_id}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
