...
import type { Stammdaten, Angebote, CreateStammdaten, CreateAngebote } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createAngeboteEntry(fields: CreateAngebote) {
    return callApi('POST', `/apps/${APP_IDS.ANGEBOTE}/records`, { fields: cleanFieldsForApi(fields as any, 'angebote') });
  }
  static async updateAngeboteEntry(id: string, fields: Partial<CreateAngebote>) {
    return callApi('PATCH', `/apps/${APP_IDS.ANGEBOTE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'angebote') });
  }
